...
lower = {'red':(170, 100, 50), 'green':(66, 122, 129), 'blue':(97, 100, 117), 'yellow':(20, 59, 100), 'orange':(5, 100, 140)}
upper = {'red':(180,255,255), 'green':(86,255,255), 'blue':(117,255,255), 'yellow':(54,255,255),'orange':(15,255,255)}
...
while True:
	...
	if rect1_center and ball_center and front_car:
		...
		print(direction)
		cv2.putText(frame,dir + ' ' + str(np.degrees(angle)),
